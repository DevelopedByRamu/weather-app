...
function getBackgroundImage(weatherMain) {
  const backgroundMap = {
    ...
    Mist: "bg img/partly cloudly background.jpeg",
    Smoke: "bg img/partly cloudly background.jpeg",
    Haze: "bg img/partly cloudly background.jpeg",
    Dust: "bg img/partly cloudly background.jpeg",
    Fog: "bg img/partly cloudly background.jpeg",
    Sand: "bg img/partly cloudly background.jpeg",
